...
export const AboutAuthor: React.FC<AboutAuthorProps> = ({ user }) => {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <div className="relative w-64 h-64 mx-auto lg:mx-0">
              ...
              <img src={user.photo} alt={user.name} className="absolute inset-2 rounded-full w-60 h-60 object-cover border-4 border-neutral-800" />
            </div>
          ...
          <div className="text-center lg:text-left">
            <div className="inline-block px-4 py-1 bg-neutral-800 rounded-full mb-6">
              <p className="text-neutral-400 text-sm">{user.tagline}</p>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Hey, I'm {user.name}</h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              <a href="#" className="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-md transition-colors duration-300">
                Contact Me
              </a>
              <a href="#" className="inline-flex items-center px-6 py-3 border border-neutral-600 text-white font-medium rounded-md hover:bg-neutral-800 transition-colors duration-300">
                Subscribe
              </a>
            </div>
          </div>
